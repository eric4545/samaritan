...
`
  ...
  it('should convert markdown links to Confluence format', () => {
...
`
    ...
    // Markdown links should be converted to Confluence format [text|url]
...
`
    ...
    assert.match(content, /# Check pods are running/)
    assert.match(content, /# Test API endpoints/)
  })
})
