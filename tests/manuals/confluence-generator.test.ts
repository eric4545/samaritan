...
`
  ...
  it('should handle markdown instructions wrapped in markdown macro', () => {
...
`
    ...
    // Should wrap markdown instructions in {markdown} macro
...
`
    ...
    // Variables in markdown macro don't need escaping
    assert.match(content, /\{markdown\}/)
...
`
  ...
  it('should preserve markdown links in markdown macro', () => {
...
`
    ...
    // Markdown links should be preserved in markdown format (markdown macro handles them)
    assert.match(content, /\{markdown\}/)
