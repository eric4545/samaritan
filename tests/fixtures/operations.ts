...
/**
 * TypeScript Operation objects for testing manual generators
 *
 * These pre-parsed Operation objects are used by tests that need to test
 * generator functions in isolation (without parsing YAML).
 *
 * For YAML-based tests, use the fixtures in tests/fixtures/fixtures.ts instead.
 */

/**
 * Standard deployment operation with multiple environments
 * Used by: format-consistency.test.ts, adf-generator.test.ts, generator-unit.test.ts
 */
...
/**
 * Operation with nested sub-steps
 * Used by: adf-generator.test.ts
 */
