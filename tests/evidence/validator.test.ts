...
import { validateEvidence, validateStepEvidence } from '../../src/evidence/validator';
import { EvidenceItem, EvidenceValidationRule } from '../../src/models/evidence';
import { EvidenceType } from '../../src/models/operation';
...
describe('Evidence Validator', () => {
  ...
  it('should validate step evidence collection', () => {
    ...
    assert.strictEqual(result.valid, false);
    assert.ok(result.errors.some(e => e.includes('Missing required evidence types: log')));
  });
  ...
  it('should validate video evidence duration', () => {
    ...
    assert.strictEqual(result.valid, false);
    assert.ok(result.errors.some(e => e.includes('duration') && e.includes('exceeds')));
  });
