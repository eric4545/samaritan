...
`manual` steps offer three extra operator actions while you're working the step — they don't complete the step, so you can use any of them as many times as you like before pressing Enter to mark the step done:

```
[↵] done  ·  [c] copy  ·  [n] note  ·  [e] evidence  ·  [v] verify  ·  [s] skip  ·  [r] rollback  ·  [abort] abort
```
